...
function resultados(array $array)
{
    foreach ($array as $objeto) {
        $rastrear = rastreio($objeto);
        $dados[] = $rastrear;
    }
    
    $msg = "<table class='tabela'> \n";
    foreach ($dados as $detalhes) {
        foreach ($detalhes as $detalhe) {
            $date = $detalhe['date'];
            $hour = $detalhe['hour'];
            $location = $detalhe['location'];
            $action   = $detalhe['action'];
            $message  = $detalhe['message'];
            $change   = $detalhe['change'];
    
            $msg .= "<tr class='linha-tr'>\n";
...
function boxResultados(array $array){
    foreach ($array as $objeto) {
        $rastrear = rastreio($objeto);
        $dados[] = $rastrear;
    }
